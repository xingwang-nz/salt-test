...
if [ -n "$1" ]; then
     ...
     pillar_value="{\"setup_kc_realm\": \"True\", \"force_reload_keycloak_config\": \"True\", \"kc_master_admin_username\": \""$kc_master_admin_username"\", \"kc_master_admin_password\": \""$kc_master_admin_password"\"}"
     echo ""
